  ...
  if (index_search_index_num === -1 && 
    ...
    if (section_value === "gpa") {
      ...
      page_contents = "<div class=\"article-login\" id=\"article-content\">\n" + 
                      ...
                      "     <form id=\"loginForm\" name=\"loginForm\" method=\"post\" action=\"http://bundang.leadersacademy.com/lib/member/process.php\" onsubmit=\"return checkLoginForm(this);\">\n" + 
                      "       <input type=\"hidden\" name=\"cmd\" value=\"login\">\n" + 
                      "       <input type=\"hidden\" name=\"logintype\" value=\"member\">\n" + 
                      "       <input type=\"hidden\" name=\"aca_number\" value=\"73176\">\n" + 
                      "       <input type=\"hidden\" name=\"nexturl\" value=\"\">\n" + 
                      "       <input type=\"hidden\" name=\"domain\" value=\"bundang.leadersacademy.com\">\n" + 
                      "       <input type=\"hidden\" id=\"PHPSESSID\" name=\"PHPSESSID\" value=\"1dd57c3654430939e5da10ade0f2fc13\">\n" + 
                      "       <div class=\"form-row\" id=\"form-row-1\">\n" + 
                      "         <img src=\"http://bundang.leadersacademy.com/skin/_modules/member/default/img/login_id.gif\"><input type=\"text\" id=\"member_id\" name=\"member_id\" value=\"\" class=\"input_login\" tabindex=\"11\">\n" +
                      "       </div>\n" + 
                      "       <div class=\"form-row\" id=\"form-row-2\">\n" + 
                      "         <img src=\"http://bundang.leadersacademy.com/skin/_modules/member/default/img/login_pw.gif\"><input type=\"password\" id=\"member_passwd\" name=\"member_passwd\" class=\"input_login\" tabindex=\"12\">\n" +
                      "       </div>\n" + 
                      "       <div id=\"form-button\">\n" + 
                      "         <input type=\"image\" src=\"http://bundang.leadersacademy.com/skin/_modules/member/default/img/btn_login.gif\" tabindex=\"13\">\n" +
                      "       </div>\n" + 
